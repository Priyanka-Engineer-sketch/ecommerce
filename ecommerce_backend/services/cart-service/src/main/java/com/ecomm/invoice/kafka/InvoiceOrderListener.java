...
public class InvoiceOrderListener {
    ...
    public void handleOrderPlaced(OrderPlacedEvent event) {
        log.info("Received OrderPlacedEvent for invoice & email: {}", event);
        ...
        try {
            ...
            body.append("Hi ").append(event.getUserEmail()).append(",\n\n");
            ...
            if (event.getItems() != null) {
                event.getItems().forEach(item -> body.append(" - ")
            ...
            body.append("You can download the invoice later from your order history.\n\n");
            body.append("Regards,\nE-Comm Team\n");
